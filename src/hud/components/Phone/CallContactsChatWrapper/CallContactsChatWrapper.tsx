...
import classes from '../../../../styles/hud/components/Phone/CallContactsChatWrapper/CallContactsChatWrapper.module.scss';
...
const CallContactsChatWrapper: React.FC<Props> = React.memo(({ openedScreen }) => {
  ...
  return (
    <div className={classes.CallContactsChatWrapper} {...handlers}>
      ...
      <div className={classes.ContentWrapper}>{screenContent}</div>
    </div>
  );
});
