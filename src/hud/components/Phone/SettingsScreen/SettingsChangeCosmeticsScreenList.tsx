...
import { ThemesArray, ThemesEnum } from '../../../../models/hud/phone/enums';
...
const SettingsChangeCosmeticsScreenList: React.FC<Props> = ({ theme, themeImage }) => {
  // theme image
  const [selectedImage, setSelectedImage]: [ThemeImageInterface, any] = useState({
    title: themeImage,
  ...
  return (
    <SettingsChangeCosmeticsScreenListStateless
      theme={theme}
