...
import { OpenedScreenEnum, PlayerAvatarsArray } from '../../../../models/hud/phone/enums';
...
const AddNewContactScreen = () => {
  ...
  const [selectedImage, setSelectedImage]: [ImportedImageInterface, any] = useState({
    title: 'avatar1',
    image: defaultAvatar,
  });
  // array of images
  ...
  return (
    <AddNewContactScreenStateless
      ...
      onNameTextChange={nameTextChangeHandler}
      onPhoneTextChange={phoneTextChangeHandler}
      onAddContact={addContactClickHandler}
      onOpenMainScreen={openMainScreen}
      handlers={handlers}
    />
  );
};
