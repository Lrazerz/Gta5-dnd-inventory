...
import {setIsOpenedInteractionsAction} from "../../../../redux/actions/hud/interactions";
import {
  mpTrigger_interactions_closeInteractions,
  mpTrigger_interactions_openInteraction
} from "../../../../utils/mpTriggers/hud/hudMpTriggers";

// test on isOpened in the HudApp. container is positioned absolute, width 100%, height 100% of the screen
// sort array, find dimensions and pass dimensions to ui component Interactions
...
const InteractionsContainer = React.memo(() => {
  ...
  const pickInteractionHandler = (interactionName: string) => {
    console.log('pick int', interactionName);
