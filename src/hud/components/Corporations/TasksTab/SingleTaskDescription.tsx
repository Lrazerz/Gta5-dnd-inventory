...
import classes from '../../../../styles/hud/components/Corporations/TasksTab/SingleTaskDescription.module.scss';
  ...
  return (
    <>
      ...
      <div className={classes.SingleCurrentTaskDescription} onClick={(e) => e.stopPropagation()}>
        <CorporationsText styles={descriptionTextStyles}>{props.description}</CorporationsText>
        <HorizontalLine styles={horizontalLineStyles} />
        <div className={classes.PayAndButtonsContainer}>
          <div className={classes.PaySumWrapper}>
            <CorporationsText styles={sumTextStyles}>{`Выплата: ${props.sum}`}</CorporationsText>
          ...
          {!props.isArchive && (
            <div className={classes.DoneFailButtonsContainer}>
              <div style={doneFailButtonStyles} className={classes.DoneButton} onClick={onDonePressHandler}>
                <CorporationsText styles={doneButtonTextStyles}>Задание выполнено</CorporationsText>
