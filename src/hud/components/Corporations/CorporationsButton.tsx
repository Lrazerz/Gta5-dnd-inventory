...
const CorporationsButton: React.FC<Props> = ({ onClick, title, styles, imageUrl, imageWidth, titleTextStyles }) => {
  ...
  return (
    <div style={styles} className={classes.CorporationsButton} onClick={onClick}>
      ...
      <div className={classes.TitleTextWrapper}>
        <CorporationsText styles={{ ...titleTextStylesLocal, ...titleTextStyles }}>{title}</CorporationsText>
      </div>
    </div>
  );
};
