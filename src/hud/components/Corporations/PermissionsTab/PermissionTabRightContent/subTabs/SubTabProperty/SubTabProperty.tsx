...
import classes
  from '../../../../../../../styles/hud/components/Corporations/PermissionsTab/PermissionTabRightContent/subTabs/SubTabProperty/SubTabProperty.module.scss';
import PermissionsPropertyTabsList from "./PermissionsPropertyTabsList";
import {PermissionsPropertyTabsEnum} from "../../../../../../models/corporations/tabs/permissions/tabs/propertyEnums";
import {SingleRoleInterface} from "../../../../../../models/corporations/interfaces";
import PropertyOfficeTab from "./tabs/PropertyOfficeTab";
import {PermissionsPropertyOfficeInitialStateInterface} from "../../../../../../models/corporations/tabs/permissions/tabs/propertyInterfaces";
...
const SubTabProperty = React.memo(() => {
  ...
  const openedTab: PermissionsPropertyTabsEnum = useSelector(state => state.hud.corporations.tabs.permissions.tabs.property.property.openedTab);
  const openedRole: SingleRoleInterface = useSelector(state => state.hud.corporations.tabs.permissions.permissions.selectedRole);
  ...
  useEffect(() => {
    ...
    if(!window.permissions_property_openOffice) {
      ...
      window.permissions_property_openOffice = (jsonData) => {
        const parsedData: PermissionsPropertyOfficeInitialStateInterface
          = window_corporations_permissions_property_openOffice(jsonData);
