...
import EquippedClosingContainer from './components/SideContainers/EquippedClothingContainer/EquippedClosingContainer';
...
const InventoryAppStateless: React.FC<Props> = React.memo(function InventoryAppStateless({
  contextMenu,
  tooltipStyles,
  onTooltipMouseOver,
  onContainersMouseOver,
}) {
  return (
    <>
      ...
      <div className={classes.AppContainer}>
        ...
        {contextMenu.contextItem && !contextMenu.splitMenuOpen && (
          <ContextMenu
