...
const ContextMenu: React.FC<Props> = React.memo(function ContextMenu({
  leftOffset,
  topOffset,
  contextItem,
  hoveredArea,
  ...
  return (
    <div
      ...
      style={{ left: leftOffset, top: topOffset, height: `${height}%` }}
        ...
        {contextActions.map((action, i) => {
          return (
            <div
              ...
              style={{
                backgroundColor: action.label.toLowerCase() === 'выкинуть' ? '#FF5306' : '#3A72F7',
              }}
            >
              <SecondaryText
                styles={{
