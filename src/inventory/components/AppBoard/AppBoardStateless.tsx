...
const AppBoardStateless: React.FC<Props> = React.memo(function AppBoard({
  onMouseOver,
  squares,
  isShowExternalBoard,
  externalBoardRowsCount,
  ...
  return (
    <div className={classes.AppBoard} onMouseOver={onMouseOver}>
      ...
      {isShowExternalBoard && (
        <>
          <ExternalBoard rowsCount={externalBoardRowsCount}>{externalInventorySquares}</ExternalBoard>
