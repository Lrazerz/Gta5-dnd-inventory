...
const EquippedWeaponsContainer: React.FC<Props> = React.memo(function EquippedWeaponsInventoryContainer({
  ...
  const getCell: (number) => SingleCell = (id) => ({
    id,
    cell: equippedCells[id],
  });
  ...
  return (
    <EquippedWeaponsContainerStateless
      ...
      heavyWeaponCells={heavyWeaponCells}
      phoneCell={phoneCell}
      simCell={simCell}
    />
  );
