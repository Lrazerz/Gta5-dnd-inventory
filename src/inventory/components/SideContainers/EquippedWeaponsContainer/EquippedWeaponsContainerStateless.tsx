...
const EquippedWeaponsContainerStateless: React.FC<Props> = React.memo(
  function EquippedWeaponsInventoryContainer({onMouseOver, equippedContainerStyles, primaryWeaponCells,
                                               secondaryWeaponCells, heavyWeaponCells, phoneCell, simCell}) {
