...
const EquippedClosingContainer: React.FC<Props> = React.memo(function EquippedClosingInventoryContainer({
  ...
  const conditions_to_z_index_200 = draggedItem && !goingToDropOnThisSquare && !hoveredSquareFromClosingInventory;
  ...
  return (
    <EquippedClosingContainerStateless
      onMouseOver={equippedContainerMouseOverHandler}
      equippedContainerStyles={equippedContainerStyles}
      headdressCells={headdressCells}
      outerwearCells={outerwearCells}
      pantsCells={pantsCells}
      shoesCells={shoesCells}
