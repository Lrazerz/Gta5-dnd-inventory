...
const EquippedClosingContainerStateless: React.FC<Props> = React.memo(
  function EquippedClosingInventoryContainer({onMouseOver, equippedContainerStyles, headdressCells,
                                               outerwearCells, pantsCells, shoesCells, accessoriesCells}) {

    return (
      <div style={equippedContainerStyles} className={classes.EquippedClosingInventoryContainer}
