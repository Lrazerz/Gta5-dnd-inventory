...
import {PermissionsPropertyTabsDict} from "../../../../../../../hud/models/corporations/tabs/permissions/tabs/propertyEnums";
...
const mpTrigger_permissions_property_office_changeOption =
  (openedRoleTitle: string, optionTitle: string, optionValue: string | boolean) => {
  console.log('cef_cl_corporations_permissions_auto_changeOption', openedRoleTitle, CorporationsTabsDict.permissions,
    CorporationsPermissionsTabsDict.property, PermissionsPropertyTabsDict.office, optionTitle, optionValue)
  try {
    const data = JSON.stringify({
      OpenedRole: openedRoleTitle,
      OpenedTab: CorporationsTabsDict.permissions,
...
export {
  mpTrigger_corporations_permissions_property_openTab,
  mpTrigger_permissions_property_office_changeOption
}