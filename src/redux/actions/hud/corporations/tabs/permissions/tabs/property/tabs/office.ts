...
const permissionsPropertyOfficeChangeOption = (optionTitle, optionValue) => {
  return { type: PERMISSIONS_PROPERTY_OFFICE_CHANGE_OPTION, title: optionTitle, value: optionValue}
}

export {
  permissionsPropertyOfficeSetOptions,
  permissionsPropertyOfficeChangeOption
}