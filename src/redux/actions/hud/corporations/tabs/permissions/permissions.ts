...
const permissionsSetRolesPermissions = (
  roles: SingleRoleInterface[],
  selectedRoleTitle: string,
  permissions: CommonPermissionsSetInterface[],
) => {
  return {
    type: PERMISSIONS_ROLES_PERMISSIONS_SET,
    roles,
    selectedRoleTitle,
    permissions,
  };
...
// from server
const permissionsSetRoleInfoAction = (roleInfo: { commonPermissionsSets: CommonPermissionsSetInterface[] }) => {
  return {
    type: PERMISSIONS_ROLE_SET_INFO,
    permissionsSets: roleInfo.commonPermissionsSets,
  };
};
...
const permissionsChangePermission = (setTitle: string, permissionTitle: string, value: boolean) => {
  return {
    type: PERMISSIONS_PERMISSION_CHANGE,
    setTitle,
    permissionTitle,
    value,
  };
