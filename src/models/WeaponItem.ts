...
export default class WeaponItem extends Item {
  ...
  constructor(id: string, name: string, category: ItemCategories | string, mainCell: [number, number], width: number, height: number,
              currentCount: number, imageUrl: string | null, isEquipped = false, rest: any, mainCellOnBoard = mainCell) {
    super(id, name, category, mainCell, width, height, currentCount, imageUrl, isEquipped, rest);
