...
//               isEquipped = false, isRotated = false, rest: any, mainCellOnBoard = mainCell) {
//     super(id, name, category, mainCell, width, height, currentCount, maxCount, imageUrl, isEquipped, isRotated, rest);
